...
public class MetalView: NSObject, MTKViewDelegate {
    ...
    func setUpTexture() {
        ...
        texture = try! textureLoader.newTexture(withContentsOf: URL(fileURLWithPath: path!), options: [MTKTextureLoaderOptionSRGB: false as NSObject, MTKTextureLoaderOriginBottomLeft: true as NSObject])
    }
